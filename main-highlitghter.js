...
var find_html = /<\s+[^>]+>/g;
var find_html_attr = /style|class|id|type|name|placeHolder|ng-app|ng-repeat|ng-src|ng-app-data|ng-[^n]/g;
var find_html_string = find_string;

// The patterns for Python code.
var find_PY_function = /from|inport|print|def|pass|in/g;
